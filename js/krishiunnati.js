...
//         starsCtx.beginPath();
//         starsCtx.fillStyle = "rgba(242, 194, 0, " + opacity + ")";
...
let spinnerWrapper = document.querySelector('.spinner-wrapper');
    ...
    window.addEventListener('load', function () {
        ...
        document.querySelector('.wrapper-Main').classList.add('fade-in');
    });
...
//     $(".problemStatement").removeClass(".problemStatementHidden");
//  },
//  function(){
//     $(".problemStatement").removeClass(".problemStatementVisible");
